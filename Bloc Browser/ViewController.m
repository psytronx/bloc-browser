...
- (void)loadView {
    ...
    for (UIView *view in @[self.webView, self.textField, self.backButton, self.forwardButton, self.stopButton, self.reloadButton]) {
...
- (void) viewWillLayoutSubviews {
    ...
    for (UIView *view in @[self.backButton, self.forwardButton, self.stopButton, self.reloadButton]) {
        view.frame = CGRectMake(currentButtonX * buttonWidth, CGRectGetMaxY(self.webView.frame), buttonWidth, itemHeight);
        currentButtonX++;
    }
